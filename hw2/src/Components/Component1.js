...
function Component3() {
  ...
  function addTask() {
    ...
    taskTable.push(<div className="task" id={newTaskName} key={newTaskName}>
    ...
    <button
      onClick={(e) => {     
        let deleteTarget = document.getElementById(`${e.target.parentNode.id}`);
        ...
        >
          <div style={c1Style} className="inner-layer">
            ...
            <div>
              ...
              <input className="input-group" id="newtask-name" type="text" onChange={getTaskName} />
            </div>
            <div>
